;(function () {
  ...
  */
  ...
  function drawSubunits(data) {
    ...
    var geoData = topojson.feature(data, data.objects[this.options.scope])
      .features
  ...
  Datamap.prototype.draw = function () {
    ...
    function draw(data) {
      ...
      if (
        ...
        const popup = app.select('.datamaps-hoverover')
  ...
  ***************************************/
  ...
  Datamap.prototype.updatePopup = function (element, d, options) {
    ...
    element.on('mousemove', function () {
      ...
      var topPos = self.options.y + areaT + position[1] + 15
      var leftPos = self.options.x + areaL + position[0] + 10
      var xDiff = leftPos + 230 - innerWidth
      var yDiff = topPos + 70 - innerHeight
      if (xDiff > 0) {
        leftPos -= xDiff
      }
      if (yDiff > 0) {
